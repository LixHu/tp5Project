<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"/home/wwwroot/housekeeping/public/../application/admin/view/users/addedit_user.html";i:1510103395;s:78:"/home/wwwroot/housekeeping/public/../application/admin/view/public/header.html";i:1510103395;s:78:"/home/wwwroot/housekeeping/public/../application/admin/view/public/footer.html";i:1510103395;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
      ...
      <div class="form-group">
        ...
        <select name="vip_card" class="input w50">
            <?php if(is_array($card) || $card instanceof \think\Collection || $card instanceof \think\Paginator): $i = 0; $__LIST__ = $card;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
              <option value="<?php echo $vo['id']; ?>" <?php if($card_num != '' and $vo['id'] == $card_num): ?> selected<?php endif; ?>><?php echo $vo['type']; ?></option>

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\WWW\my\housekeeping\public/../application/admin\view\admin\right.html";i:1511232378;}*/ ?>
	...
	<div class="panel_box row">
		<div class="panel col remind">
			<a href="javascript:;" data-url="page/message/message.html">
				...
				<div class="panel_word newMessage">
					<span><?php echo $info['remind']; ?></span>
					<cite>待处理事项</cite>
				</div>
			</a>
		</div>
		...
		<div class="panel col">
			<a href="javascript:;" data-url="page/user/allUsers.html">
				...
				<div class="panel_word userAll">
					<span><?php echo $info['ucount']; ?></span>
					<cite>会员数量</cite>
				</div>
			</a>
		</div>
		...
		<div class="panel col">
			<a href="javascript:;" data-url="page/news/newsList.html">
				...
				<div class="panel_word waitNews">
					<span><?php echo $info['gcount']; ?></span>
					<cite>家政人员数量</cite>
				</div>
			</a>
		</div>
		<div class="panel col max_panel">
			<a href="javascript:;" data-url="page/news/newsList.html">
				...
				<div class="panel_word allNews">
					<span><?php echo $info['ocount']; ?></span>
					<em>订单数量</em>
					<cite>文章列表</cite>
				</div>
			</a>

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\WWW\my\housekeeping\public/../application/admin\view\admin\index.html";i:1511232378;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top"><input type="hidden" id="admin_id" value="<?php echo \think\Session::get('admin')['admin_id']; ?>">
...
<div class="leftnav">
 <a href="<?php echo url('admin/index'); ?>"> <div class="leftnav-title"><strong><span class="icon-list"></span>首页</strong></div></a>
  <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <h2><span></span><?php echo $vo['left_name']; ?></h2>

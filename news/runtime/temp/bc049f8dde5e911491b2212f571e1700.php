    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <?php if(is_array($menu) || $menu instanceof \think\Collection || $menu instanceof \think\Paginator): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <input type="checkbox" name="id[]" value="<?php echo $vo['menu_id']; ?>" class="parent" lay-filter="test" id="parent"
                <?php
                    if(!empty($role_name)){
                ...
                <br/>
                <?php if(is_array($vo['children']) || $vo['children'] instanceof \think\Collection || $vo['children'] instanceof \think\Paginator): $ke = 0; $__LIST__ = $vo['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($ke % 2 );++$ke;?>
                    <input type="checkbox" name="id[]" value="<?php echo $v['menu_id']; ?>" class="children" <?php
                        if(deep_in_array($v['menu_id'],$role_name)) echo 'checked';
                        ?>
                        > <?php echo $v['menu_name']; endforeach; endif; else: echo "" ;endif; ?>
                <br/>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>

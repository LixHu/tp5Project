			...
			<div class="connoisseur">
				<div>
					...
					<div style="float:right;display:inline-block;padding:20px;">
						<button type="button" class="layui-btn layui-btn-normal" data-method="add" data-url="<?php echo url('users/addedit_user'); ?>"><i class="layui-icon">&#xe654;</i>添加用户</button>
					</div>
				</div>
				<!-- user 表格 显示 -->
				<div class="conShow">
							...
							<tr height="40px">
								...
								<td>
									<div class="layui-btn-group">
										<a class="layui-btn layui-btn-normal" href="addedit_user?id=<?php echo $vo['user_id']; ?>">编辑</a>

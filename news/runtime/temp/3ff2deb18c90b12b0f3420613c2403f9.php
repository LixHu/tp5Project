		...
		<div class="pageTop">
			<div class="page">
				<img src="__IMG__/coin02.png" /><span><a href="#">首页</a>&nbsp;-&nbsp;<a
					href="#">网站管理</a>&nbsp;-</span>&nbsp;权限管理
			</div>
		</div>
		<div class="page">
			<button type="button" style="float:right;" class="layui-btn layui-btn-normal" data-method="add" data-url="<?php echo url('admin/add_role'); ?>"><i class="layui-icon">&#xe654;</i>添加角色</button>
			<!-- opinion 页面样式 -->
			<div class="opinion">
				<!-- opinion 表格 显示 -->
				<div class="opShow">
					<table class="layui-table">
						...
						<?php if(is_array($role_list) || $role_list instanceof \think\Collection || $role_list instanceof \think\Paginator): $i = 0; $__LIST__ = $role_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
							<tr height="40px">
								<td><input type="checkbox" name="id[]" value="<?php echo $vo['role_id']; ?>"></td>
								<td><?php echo $vo['role_name']; ?></td>
								<td><?php echo $vo['role_desc']; ?></td>
								<td>
									<div class="layui-btn-group">
										<a type="button" class="layui-btn layui-btn-normal"  href="edit_role?id=<?php echo $vo['role_id']; ?>">查看权限</a>
										<button type="button" class="layui-btn layui-btn-danger" data-method='del' data-id="<?php echo $vo['role_id']; ?>">删除</button>
									</div>
								</td>
							</tr>

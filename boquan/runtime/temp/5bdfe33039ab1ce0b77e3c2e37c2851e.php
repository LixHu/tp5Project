<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"F:\zm\my\boquan\public/../application/boquan\view\workorder\workorder_new.html";i:1521185985;s:58:"F:\zm\my\boquan\application\boquan\view\public\header.html";i:1520643971;s:58:"F:\zm\my\boquan\application\boquan\view\public\footer.html";i:1520643971;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            processResults: function (data, params) {
                ...
                if(dataList.length > 0){
                    for (var i = 0; i < dataList.length; i++) {
                        itemList[i] = {
                            id: dataList[i].gid,
                            text: dataList[i].gname,
                            phone: dataList[i].tel
                        };
                    }
                    return {
                        results: itemList,

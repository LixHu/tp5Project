<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"F:\zm\my\boquan\public/../application/boquan\view\user\reg.html";i:1520995254;s:58:"F:\zm\my\boquan\application\boquan\view\public\header.html";i:1520643971;s:58:"F:\zm\my\boquan\application\boquan\view\public\footer.html";i:1520643971;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div style="width: 100%;height: 100vh;background: #eeeeee url('_images/new/login_bg.png') center no-repeat;display: flex;align-items: center;background-size: 100% 100vh;">
    <div style="margin: 0 auto;width: 500px;height: 527px;background: transparent;text-align: center;box-shadow: 0px 0px 30px #888888;">
        <div style="margin: 50px 100px;">
            ...
            <br />
            <div style="clear:both;"></div>
            <a style="float: right;padding:10px;color:#6d6666;" href="<?php echo url('user/reg_server'); ?>">成为服务商>></a>
        </div>
    </div>
</div>
<script>

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"F:\zm\my\boquan\public/../application/boquan\view\clientall\custom_list.html";i:1521181688;s:58:"F:\zm\my\boquan\application\boquan\view\public\header.html";i:1520643971;s:58:"F:\zm\my\boquan\application\boquan\view\public\footer.html";i:1520643971;}*/ ?>
<!DOCTYPE html>
<html lang="en">
					...
					<div class="row">
						<div class="col-md-6 col-sm-6">
							<!-- <div class="btn-group" id="auth_delete"> -->
								<a href="javascript:location.reload();" class="btn btn-primary btn-sm checkbox-toggle">全部</a> 
								<a href="javascript:;" onclick="addcustom()" class="btn btn-primary btn-sm checkbox-toggle">添加客户</a>
...
<script>
	function addcustom() {
		layer.open({
			...
			area:['780px','400px'],
			closeBtn:1,
			content:"<?php echo url('Clientall/add_custom'); ?>"
		})
	}
</script>
						<div class="col-md-6 col-sm-6">
							<form id="mainForm" action="search_service" method="get"
								...
								<div class="input-group">
									<input type="text" class="form-control keyword-search criteria"
										...
										<button class="btn btn-primary" type="submit" id="btnSearch">搜 索</button>
									</span>
								</div>
							</form>
						</div>
						...
						<table class="table table-hover table-striped table-bordered"
							...
							<tbody>
								<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
									<tr>
										<td><input type="checkbox" class="checkSelect" name="checkSelect" value="<?php echo $vo['gid']; ?>"></td>
										...
										<td><a href="javasctipy:;" onclick="relieve(<?php echo $vo['gid']; ?>)" class="btn btn-danger btn-sm checkbox-toggle">删除</a>
...
<script>
    ...
    var relieve = function (id) {
        var data= {};
        data.gid = id;
        if(confirm('确定要删除吗？')){
            $.post('relieve',data,function (res) {
                console.log(res);
                alert(res.msg);
                if(res.code == 1){
                    location.reload();

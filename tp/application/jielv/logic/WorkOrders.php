...
//        }
        ...
        $wlist = self::alias('a')
                ->field('a.*,
                e.*,b.nick_name as jour_name,b.mobile as jour_mobile,c.nick_name as add_name,d.user_name as ass_name,
                d.address as ass_add,d.mobile as ass_mobile,f.user_name as take_name,cl.client_name as cus_name,cl.client_tel as cus_mobile
                ,cl.client_address as cus_address')
...
//        }
        if($status){
            ...
            $list = self::alias('a')
                ->field('a.*,e.*,b.nick_name as jour_name,b.mobile as jour_mobile,c.nick_name as add_name,d.user_name as ass_name,
                d.address as ass_add,d.mobile as ass_mobile,f.user_name as take_name,cl.client_name as cus_name,cl.client_tel as cus_mobile
                ,cl.client_address as cus_address')
                ->join('users b','a.jour_id = b.uid','left')
                ->join('users c','a.add_uid = c.uid','left')

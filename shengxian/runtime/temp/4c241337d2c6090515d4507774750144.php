<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpStudy\WWW\my\shengxian\public/../application/admin\view\admin\right.html";i:1511234215;}*/ ?>
	...
	<div class="panel_box row">
		<div class="panel col remind">
			<a href="javascript:;" data-url="page/message/message.html">
				...
				<div class="panel_word newMessage">
					<span><?php echo $info['tixing']; ?></span>
					<cite>待处理事项</cite>
				</div>
			</a>
		</div>
		...
		<div class="panel col">
			<a href="javascript:;" data-url="page/user/allUsers.html">
				...
				<div class="panel_word userAll">
					<span><?php echo $info['user_count']; ?></span>
					<cite>会员数量</cite>
				</div>
			</a>
		</div>
		...
		<div class="panel col">
			<a href="javascript:;" data-url="page/news/newsList.html">
				...
				<div class="panel_word waitNews">
					<span><?php echo $info['goods_count']; ?></span>
					<cite>商品数量</cite>
				</div>
			</a>
		</div>
		<div class="panel col max_panel">
			<a href="javascript:;" data-url="page/news/newsList.html">
				...
				<div class="panel_word allNews">
					<span><?php echo $info['order_count']; ?></span>
					<em>订单数量</em>
					<cite>文章列表</cite>
				</div>
			</a>
		...
		<div class="sysNotice col">
			...
			<!-- <div class="layui-elem-quote layui-quote-nm"> -->
				<table class="layui-table">
					...
					<?php if(is_array($info['_order']) || $info['_order'] instanceof \think\Collection || $info['_order'] instanceof \think\Paginator): $i = 0; $__LIST__ = $info['_order'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr>
							<td><?php echo $vo['order_sn']; ?></td>
							<td><?php if(!empty($vo['add_time'])): ?><?php echo date("Y-m-d H:i:s",$vo['add_time']); endif; ?></td>
							<td>
								<a href="<?php echo url('order/order_list'); ?>" class="layui-btn">前去处理</a>
							</td>
						</tr>

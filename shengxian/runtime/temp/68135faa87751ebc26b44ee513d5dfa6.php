  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<?php echo url('shipping/addedit_info'); ?>"> 添加配送方式</a> </li>
    ...
    <table class="table table-hover text-center">
      <tr>
        ...
        <th>操作</th>
      	...
      	<?php if(is_array($shipping_list) || $shipping_list instanceof \think\Collection || $shipping_list instanceof \think\Paginator): $i = 0; $__LIST__ = $shipping_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	        <tr>
	          <td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="<?php echo $vo['shipping_id']; ?>" /></td>
	          <td><?php echo $vo['name']; ?></td>
              <td><?php echo $vo['desc']; ?></td>
	          <td><div class="button-group"> <a class="button border-main" href="<?php echo url('shipping/addedit_info','id='.$vo['shipping_id']); ?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="javascript:void(0)" onclick="return del(<?php echo $vo['shipping_id']; ?>)"><span class="icon-trash-o"></span> 删除</a> </div></td>
	        </tr>

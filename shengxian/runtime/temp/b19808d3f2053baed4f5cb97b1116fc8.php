<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\phpStudy\WWW\my\shengxian\public/../application/admin\view\banner\banner_list.html";i:1511233310;s:80:"D:\phpStudy\WWW\my\shengxian\public/../application/admin\view\public\header.html";i:1511320558;s:80:"D:\phpStudy\WWW\my\shengxian\public/../application/admin\view\public\footer.html";i:1511233311;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<form method="post" action="" id="listform">
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 广告图片管理</strong> <a href="" style="float:right; display:none;">添加字段</a></div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<?php echo url('banner/addedit_banner'); ?>"> 添加图片</a> </li>
    ...
    <table class="table table-hover text-center">
      ...
      <?php if(is_array($banner) || $banner instanceof \think\Collection || $banner instanceof \think\Paginator): $i = 0; $__LIST__ = $banner;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <tr>
              ...
              <td><img src="<?php echo $vo['img_url']; ?>" width="50" height="50" alt=""></td>
              <td><?php echo $vo['is_show']; ?></td>
              <td><?php echo $vo['pos']; ?></td>
              <td><div class="button-group"> <a class="button border-main" href="<?php echo url('banner/addedit_banner','id='.$vo['id']); ?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="javascript:void(0)" onclick="return del(<?php echo $vo['id']; ?>)"><span class="icon-trash-o"></span> 删除</a> </div></td>
            </tr>
...
function del(id){
 var  data = {"id":id};
	if(confirm("您确定要删除吗?")){
		$.post('/admin/banner/del_img',data,function(msg){
          if(msg.code != -1){
              alert(msg.msg);
              window.history.go(0);
          }
